...
function createProduct(productoData) {
    MesaService.createProduct(productoData)
        .then((response) => {
...
function updateProduct(productoData) {
    MesaService.updateProduct(product.value.id, productoData)
        .then((response) => {
...
function deleteProduct() {
    MesaService.deleteProduct(product.value.id)
        .then(() => {
...
function deleteSelectedProducts() {
    const deletePromises = selectedProducts.value.map((product) => MesaService.deleteProduct(product.id));
    ...
    <div>
        <div class="card">
            ...
            >
                ...
                <Column field="numeroMesa" header="Numero de Mesa" sortable style="min-width: 16rem"></Column>
                <Column field="capacidad" header="Capacidad personas" sortable style="min-width: 10rem"></Column>
                <Column field="ubicacion" header="Ubicacion" sortable style="min-width: 16rem"></Column>
