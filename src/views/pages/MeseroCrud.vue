...
function createProduct(productoData) {
    MeseroService.createProduct(productoData)
        .then((response) => {
...
function updateProduct(productoData) {
    MeseroService.updateProduct(product.value.id, productoData)
        .then((response) => {
...
function deleteProduct() {
    MeseroService.deleteProduct(product.value.id)
        .then(() => {
...
function deleteSelectedProducts() {
    const deletePromises = selectedProducts.value.map((product) => MeseroService.deleteProduct(product.id));
    ...
    <div>
        <div class="card">
            ...
            >
                ...
                <Column field="usuario.numeroDocumento" header="Identificacion" sortable style="min-width: 16rem"></Column>
                <Column field="usuario.nombre" header="Nombre" sortable style="min-width: 16rem"></Column>
                <Column field="usuario.apellido" header="Apellido" sortable style="min-width: 16rem"></Column>
                <Column field="usuario.email" header="Email" sortable style="min-width: 16rem"></Column>
                <Column field="usuario.rol.nombre" header="Rol" sortable style="min-width: 16rem"></Column>
