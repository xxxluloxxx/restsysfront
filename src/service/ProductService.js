...
export const ProductService = {
    ...
    async getProductsData2() {
        console.log('🚀 Iniciando petición a la API de productos4444...');
        try {
            ...
            const transformedProducts = response.data.map((product) => ({
                ...
                quantity: product.stockDisponible,
                inventoryStatus: this.getInventoryStatus(product.stockDisponible),
                rating: null
            }));

            console.log('🔄 Productos transformados:', transformedProducts);
            console.log(`📊 Total de productos procesados: ${transformedProducts.length}`);
